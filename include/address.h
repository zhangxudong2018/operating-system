...
#define SRAM_CACHE_INDEX_LENGTH (6)     // CI
#define SRAM_CACHE_OFFSET_LENGTH (6)    // CO
#define SRAM_CACHE_TAG_LENGTH (4)      // CT

#endif

#define PHYSICAL_PAGE_OFFSET_LENGTH (12)    // PPO
#define PHYSICAL_PAGE_NUMBER_LENGTH (4)     // PPN
#define PHYSICAL_ADDRESS_LENGTH (16)

#define VIRTUAL_PAGE_OFFSET_LENGTH (12)     // VPO
#define VIRTUAL_PAGE_NUMBER_LENGTH (9)  // 9 + 9 + 9 + 9 = 36 VPN
#define VIRTUAL_ADDRESS_LENGTH (48)

#define TLB_CACHE_OFFSET_LENGTH (12)    // TLBO
#define TLB_CACHE_INDEX_LENGTH (4)      // TLBI
#define TLB_CACHE_TAG_LENGTH (32)       // TLBT
